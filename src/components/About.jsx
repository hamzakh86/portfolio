  ...
  >
    ...
    >
      <div className='bg-tertiary rounded-[20px] py-5 px-12 min-h-[280px] flex justify-evenly items-center flex-col'>
        ...
        <h3 
          className='text-text-primary text-[20px] font-bold text-center' 
          style={{ color: ["Frontend Developer", "Backend Developer", "React Native Developer", "Full Stack Js Developer"].includes(title) ? 'white' : 'inherit' }}
        >
          {title}
        </h3>
      </div>
  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        <p className={styles.sectionSubText} style={{ color: 'rgb(71 85 105 / var(--tw-text-opacity))' }}>
          Introduction
        </p>
        <h2 className={styles.sectionHeadText} style={{ color: 'rgb(71 85 105 / var(--tw-text-opacity))' }}>
          Overview.
        </h2>
      </motion.div>
